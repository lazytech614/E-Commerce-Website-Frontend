  ...
  return (
    <div className='sm:min-h-[90vh] px-4 sm:px-10 md:px-20 mt-[60px] sm:mt-0'>
        <div className='flex justify-between items-center'>
          ...
          <button onClick={handleClick} className='h-fit px-3 py-1 md:px-8 sm:py-2 flex justify-center items-center text-[12px] sm:text-[14px] md:text-[20px] text-white font-medium rounded-md hover:rounded-3xl duration-300 bg-[#ff4141]'>more...</button>
        </div>
