...
export const CITY_REQUIRED = "please enter the city";
export const PINCODE_REQUIRED = "Please enter the pin code";
export const STATE_REQUIRED = "Please enter the state";
export const COUNTRY_REQUIRED = "Please enter the country";
...
export const STREET_REQUIRED = "Please enter the street name";
