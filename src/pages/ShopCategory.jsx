    ...
    <div>     
      ...
      <div className='px-4 sm:px-10 md:px-20 mb-[40px] md:mb-[100px]'>
        <div className='flex justify-between items-center my-[70px]'>
          ...
          <div className='px-2 sm:px-4 py-1 sm:py-2 rounded-[40px] border border-[#888] text-[12px] sm:text-[16px] flex items-center gap-2 cursor-pointer'>
        ...
        <div className='w-[120px] sm:w-[140px] md:w-[180px] lg:w-[234px] h-[40px] sm:h-[50px] md:h-[60px] lg:h-[70px] bg-[#ededed] rounded-[40px] sm:rounded-[80px] text-[#787878] text-[12px] sm:text-[14px] md:text-[16px] lg:text-[18px] flex items-center justify-center ml-auto mt-[40px] cursor-pointer'>
          Explore More
        </div>
      </div>
    </div>
